...
public class CommentAdapter extends ArrayAdapter<CommentList> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.tv_comment_title.setText(c.getCommentTitle());
        holder.tv_comment_readers.setText(""+c.getCommentReaders());
        holder.tv_comment_date.setText(""+c.getCommentDate());
        holder.asv_comment_assess_star.setStarNumber(c.getCommentAssessStar());
        //TODO iv_comment_cover,riv_comment_head
        ImageLoader.getInstance().displayImage(c.getCommentCoverUrl(), holder.iv_comment_cover);
        ImageLoader.getInstance().displayImage(c.getCommentHeadUrl(), holder.riv_comment_head);
